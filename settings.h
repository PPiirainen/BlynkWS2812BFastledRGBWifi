...
#define LED_ARRANGE                 RGB
#define LED_NUMBER                  144
#define LED_LIMIT_MILLIAMPS         1000000 // Limit current in mA (Must be using FastLED v3.1.1+)
/*
...
/*
   Hardware Pins
*/
#define DATA_PIN                    18 // GPIO12 / D6 on WeMos/NodeMCU ESP8266
/*
   Virtual Pins
*/
#define vPIN_HUE                    V0
